...
- 이론 완료일: 2026-07-13
- 실습 완료일: 2026-07-13
- 관련 커밋/PR/폴더: (기존 git-intro/what-is-git.md 실습 연계)
- 비고: Git은 분산 버전 관리 시스템, GitHub는 Git 저장소 호스팅·협업 플랫폼임을 명확히 정리함.

### GitHub 계정과 저장소 개념
- 상태: 완료
- 이론 완료일: 2026-07-13
- 실습 완료일: 2026-07-13
- 관련 커밋/PR/폴더: git_selfstudy 저장소 전체
- 비고: 학습 시작부터 실제 저장소를 운영하며 이미 체험 완료.
...
- 실습 완료일: 2026-07-13
- 관련 커밋/PR/폴더:
- 비고: Public은 누구나 접근, Private은 권한 부여된 사용자만 접근. Public 저장소에 민감 정보 노출 주의.

### GitHub 저장소 생성하기
- 상태: 완료
- 이론 완료일: 2026-07-13
- 실습 완료일: 2026-07-13
- 관련 커밋/PR/폴더: git_selfstudy 저장소
- 비고: 학습 시작 시 직접 생성해서 운영 중.

### 로컬 Git 저장소와 GitHub 연결하기
- 상태: 완료
- 이론 완료일: 2026-07-13
- 실습 완료일: 2026-07-13
- 관련 커밋/PR/폴더: git-intro/local-vs-remote.md, git-first-repo/first-repo-log.md
- 비고: git remote add origin / git push -u 흐름 실습 완료. clone과 init 시작의 차이 이해.
...
- 실습 완료일: 2026-07-13
- 관련 커밋/PR/폴더: git-intro/local-vs-remote.md
- 비고: origin은 원격 저장소의 관례적 별칭. upstream은 Fork 기반 협업(GitHub 초급)에서 별도 학습 예정.

### 기본 원격 작업
- 상태: 완료
- 이론 완료일: 2026-07-13
- 실습 완료일: 2026-07-13
- 관련 커밋/PR/폴더: git-workflow/workflow-log.md, git-branch-cleanup-practice/
- 비고: push(로컬→원격 전송), fetch(원격 추적 브랜치만 갱신, 작업 폴더 불변), pull(fetch+merge, 상황에 따라 fast-forward 또는 3-way merge, 충돌 가능) 개념 정리 완료.

### README.md 작성 기초
- 상태: 완료
- 이론 완료일: 2026-07-13
- 실습 완료일: 2026-07-13
- 관련 커밋/PR/폴더: README.md (docs: add repository README)
- 비고: README는 저장소 진입점. 루트/`.github`/`docs` 인식 순서, 상대 경로 링크 사용, 현재 상태 기준 작성 원칙 학습. 학습 저장소용 README 작성 및 push 완료.
...
- 실습 완료일: 2026-07-13
- 관련 커밋/PR/폴더:
- 비고: git clone 실행 시 원격 저장소를 로컬에 복제하고 origin이 자동 등록됨. upstream tracking도 자동 설정됨.
...
- 실습 완료일: 2026-07-13
- 관련 커밋/PR/폴더:
- 비고: Code(파일·이력 탐색), Issues(버그·제안 관리), Pull requests(변경 제안·리뷰·병합), Actions(워크플로 자동화, CI/CD), Settings(저장소 설정·보호 규칙 등) 역할 파악 완료.
...
- 실습 완료일: 2026-07-13
- 관련 커밋/PR/폴더:
- 비고: 이미 실습 기록 작성 과정에서 충분히 사용해옴. GitHub README 작성 실습에서 재확인.
...
- 실습 완료일: 2026-07-13
- 관련 커밋/PR/폴더: git-workflow/workflow-log.md
- 비고: Git 입문 이후 매 실습마다 add → commit → push 흐름 반복 체험 완료.
...
- 실습 완료일: 2026-07-15
- 관련 커밋/PR/폴더: PR #1
- 비고: Request changes는 본인 PR에 직접 선택 불가(GitHub 정책).
  Comment로 오타 지적 → fix 커밋 재push → Squash merge 전체 사이클 체험.
  Squash merge 결과로 main에 커밋 1개로 압축되는 것 직접 확인.

### 코드 리뷰 기본 예절
- 상태: 완료
- 이론 완료일: 2026-07-19
- 실습 완료일: 2026-07-19
- 관련 커밋/PR/폴더: github-review-practice/, PR #2
- 비고: typo/issue/suggestion 접두어 댓글 실습 완료.
  수정된 줄의 댓글은 Outdated로 자동 전환됨을 직접 발견.
  Outdated 댓글은 리뷰어가 Resolve로 닫아주는 것이 올바른 협업 흐름임을 학습.
